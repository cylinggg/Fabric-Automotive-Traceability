...
peer lifecycle chaincode commit -o localhost:7050 \
  ...
  --channelID mychannel --name honda --version 2.0 --sequence 5 \
...
```
Committed chaincode definition for chaincode 'honda' on channel 'mychannel':
Version: 2.0, Sequence: 5, Endorsement Plugin: escc, Validation Plugin: vscc,
